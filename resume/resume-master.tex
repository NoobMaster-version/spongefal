...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Designed production PCBs for a legged consumer robot: Raspberry Pi Zero 2W and Milk-V compute carriers, 1S/2S charging and power boards running 17 motors off one pack (BQ25887 with cell balancing, MP2672, TPS562202 rails), a servo driver board, a microphone board and inter-board connector boards}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Extracted torque constant, back-EMF, Kv and torque ripple from the solved air-gap flux, predicting 40.9\,mN$\cdot$m/A rms, 496\,rpm/V and zero cogging torque for the coreless design; the built motor measures 350\,rpm/V}
    ...
    \resumeProjectHeading
      {\textbf{\href{https://spongefal.vercel.app/projects/smart-switch/}{Smart Switch Board}} $|$ \emph{ESP32, ESP-IDF, FreeRTOS, MQTT, BLE, Flutter, PCB Design}}{2025 -- Present}
      \resumeItemListStart
    ...
    \resumeProjectHeading
      {\textbf{\href{https://spongefal.vercel.app/projects/kurma/}{Kurma - Quadruped Robot}} $|$ \emph{ESP-IDF, MQTT, Kinematics}}{Jan 2025 -- Mar 2025}
      \resumeItemListStart
